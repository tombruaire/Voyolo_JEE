...
public class Users {
    ...
    public Users(int idu, String nom, String prenom, String pseudo, String email, String mdp, String role, int nbTentatives, int nbConnexion, int bloque, String last_connexion, String last_deconnexion, String creation_compte) {
        this.idu = idu;
        this.nom = nom;
        this.prenom = prenom;
        this.pseudo = pseudo;
    ...
    public Users(int idu, String nom, String prenom, String pseudo, String email, String mdp, String role) {
        this.idu = idu;
        this.nom = nom;
        this.prenom = prenom;
        this.pseudo = pseudo;
    ...
    public Users(String nom, String prenom, String pseudo, String email, String mdp, String role, int nbTentatives, int nbConnexion, int bloque, String last_connexion, String last_deconnexion, String creation_compte) {
        this.idu = 0;
        this.nom = nom;
        this.prenom = prenom;
        this.pseudo = pseudo;
    ...
    public Users(String nom, String prenom, String pseudo, String email, String mdp, String role) {
        this.idu = 0;
        this.nom = nom;
        this.prenom = prenom;
        this.pseudo = pseudo;
